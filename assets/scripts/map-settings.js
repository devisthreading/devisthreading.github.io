(function($) {
  ...
  function initialize() {
    ...
    var latitude = 33.7464347,
    longitude =  -117.86341340000001;
    ...
    if(windowWidth <= mobile){
      ...
      var officeDetails = '<div id="content">'+
        '<div id="siteNotice">'+
        '</div>'+
        '<h1 id="firstHeading" class="firstHeading"> Devi"s Threding</h1>'+
        '<div id="bodyContent">'+
        '<p>431 E First St, ' +
        '<br> Santa Ana, CA 92701</p>'+
        '<a class="tel" href="tel:714-550-1004"> (714) 550-1004</a>'+
        '<a class="btn book-now-btn get-directions" href="https://maps.google.com/?saddr=Current+Location&daddr=33.7464347,-117.86341340000001" target="_blank">Get Directions</a>'+
